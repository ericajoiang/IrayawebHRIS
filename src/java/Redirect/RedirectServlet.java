...
public class RedirectServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                request.getRequestDispatcher("RedirectEmployeeLogin").forward(request, response);
                
            }else if(redirect.equals("hradmin")){
            
                request.getRequestDispatcher("RedirectHrLogin").forward(request, response);
                    
            }else if(redirect.equals("payrollmaster")) {
