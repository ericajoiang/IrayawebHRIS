...
public class ProfileRedirect extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProfileRedirect</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ProfileRedirect at " + request.getContextPath() + "</h1>");
 
           /* LoginBean lb = new LoginBean();
            
            out.println(lb.getUsername());
            out.println(lb.getPassword());
            out.print(lb.getAccount_type());
            out.println(lb.isValid());
            ...
            */ 
            ...
            {
                request.getRequestDispatcher("/WEB-INF/View/HRAdmin/updateCivilStatus.jsp;").forward(request, response);
            }
